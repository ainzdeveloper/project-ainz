module.exports = function({ api, models, Users, Threads, Currencies }) {
  const stringSimilarity = require('string-similarity'),
    ...
    logger = require("../../catalogs/system-settings/console/console-logger.js");
  ...
  return async function({ event }) {
    ...
    const replyAD = `「⚠️」────〔☢️〕────「⚠️」\n\n𝚃𝚑𝚒𝚜 𝚋𝚘𝚝 𝚠𝚊𝚜 𝚒𝚗 𝚞𝚗𝚍𝚎𝚛𝚐𝚘𝚒𝚗𝚐 𝚖𝚊𝚒𝚗𝚝𝚊𝚒𝚗𝚊𝚗𝚌𝚎, 𝙿𝚕𝚎𝚊𝚜𝚎 𝚋𝚎 𝚙𝚊𝚝𝚒𝚎𝚗𝚝 𝚞𝚜𝚎𝚛𝚜.\n\n𝚅𝚒𝚜𝚒𝚝 𝚖𝚢 𝙳𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛 𝚠𝚑𝚒𝚕𝚎 𝚠𝚊𝚒𝚝𝚒𝚗𝚐, 𝙷𝚎𝚛𝚎\'𝚜 𝚝𝚑𝚎 𝚕𝚒𝚗𝚔:\"https://www.facebook.com/berlovesyou\"\n\n𝙳𝙰𝚃𝙴 𝙰𝙽𝙳 𝚃𝙸𝙼𝙴 𝙲𝙷𝙴𝙲𝙺:\n𝙸𝚃𝚂 𝙰𝙻𝚁𝙴𝙰𝙳𝚈 [ ${time} ]`;
    ...
    try {
      ...
      if (command && typeof command.run === 'function') {
        ...
        if (DeveloperMode == !![]) {
          logger(global.getText("handleCommand", "executeCommand", time, commandName, senderID, threadID, args.join(" "), (Date.now()) - dateNow), "[ 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥 𝗠𝗢𝗗𝗘 ]");
        }
