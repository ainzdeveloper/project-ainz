...
module.exports = (text, type) => {
  switch (type) {
    case 'warn':
      process.stderr.write(error(`\r[ 𝙴𝚁𝚁𝙾𝚁 ] `) + text + '\n');
      break;
    case 'error':
      console.log(chalk.bold.hex("#ff0000").bold(`[ 𝙴𝚁𝚁𝙾𝚁 ] `) + text + '\n');
      break;
    case 'load':
      console.log(co(`[ 𝙽𝙴𝚆 𝚄𝚂𝙴𝚁 ] `) + text + '\n');
      break;
    default:
...
module.exports.loader = (data, option) => {
  switch (option) {
    case 'warn':
      process.stderr.write(co(`[ 𝚂𝚈𝚂𝚃𝙴𝙼 ]`), data + '\n');
      break;
    case 'error':
      process.stderr.write(chalk.hex("#ff0000")(`\r[ 𝚂𝚈𝚂𝚃𝙴𝙼 ] `) + data + '\n');
      break;
    default:
      console.log(co(`[ 𝚂𝚈𝚂𝚃𝙴𝙼 ]`), data);
      break;
  }
};